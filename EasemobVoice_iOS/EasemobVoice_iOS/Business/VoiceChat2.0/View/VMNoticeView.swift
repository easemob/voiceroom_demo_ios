...
class VMNoticeView: UIView {
    ...
    func layoutUI() {
        ...
        editBtn.frame = CGRect(x: 20, y: self.bounds.size.height - (isHairScreen ? 87 : 53), width: self.bounds.size.width - 40, height: 48)
        ...
        editBtn.setBackgroundImage(UIImage(named: "blue_btn_bg"), for: .normal)
